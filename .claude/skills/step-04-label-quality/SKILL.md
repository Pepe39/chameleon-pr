...
3. Does the comment identify a genuine issue, catch a real bug,
...
4. If the comment offers multiple fix options, do those options
   ...
   -> Single option, or options that are all reasonable: continue to 5

5. Does the proposed fix introduce regressions, incompatibilities,
